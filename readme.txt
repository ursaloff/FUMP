...
5.1 - Aug 2012
Changes/Bug fixes:
    - Created FUMP repository https://github.com/ursaloff/FUMP
    - install.cgi - fixed SQL script to be compatible with MySql 5.5
    - all templates and lang files converted to UTF-8
    - Mysql connection changed to utf-8
    - default messages encoding changed to UTF-8
    - (!) all next changes will not be published in this readme file. Please follow our "FUMP Community" page on Google Plus http://goo.gl/pa9AS or see updates streem at https://github.com/ursaloff/FUMP
5.1 - March 2012
Changes/Bug fixes:
